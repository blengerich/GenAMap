...
EXPECT_NEAR(value, 4.72085848966, 1e-3);
}
...
EXPECT_NEAR(opt_ldelta0, -0.8, 1e-3);
EXPECT_NEAR(nllmin, 3.7912452605, 1e-3);
}
...
VectorXd p_true;
p_true.resize(5);
p_true << 0.3461454299702017, 0.96893502386022667, 0.029856837103504012, 0.65364898535055593, 0.18899766631170314;
