...
void NeighborSelection::updateBetaAll(MatrixXd b) {
    if (betaAll.rows() == 1){
        betaAll = b;
    }
    else{
...
MatrixXd NeighborSelection::getBetaAll() {
    return betaAll;
}
