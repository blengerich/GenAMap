...
class GMGDCDialog extends Component {
  ...
  render () {
    ...
    var DiseaseCases = [
      ...
      { key: 'Acute Myeloid Leukemia', value: 'TARGET-AML' },
      { key: 'Bladder Urothelial Carcinoma', value: 'TCGA-BLCA' },
      { key: 'Breast Invasive Carcinoma', value: 'TCGA-BRCA' },
      { key: 'Clear Cell Sarcoma of the Kidney', value: 'TARGET-CCSK' },
      ...
      { key: 'Neuroblastoma', value: 'TARGET-NBL' },
      { key: 'Osteosarcoma', value: 'TARGET-OS' },
